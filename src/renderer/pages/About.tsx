    ...
    return (
        <div>
            ...
            <p>Our vision is to make time management into a shared, collaborative activity. 
                ...
                We aim to eliminate the struggles of manual coordination, creating a world where shared accountability is built into every tick of the clock, ensuring that when it’s time to act, everyone is ready to move together.</p>
        </div>
    );
}